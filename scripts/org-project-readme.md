# IMPACT programme board (SSOT)

**Workflow truth:** **Status** on each card (not issue titles).

| Link | Use |
| ---- | --- |
| [Issues](https://github.com/sovereignsquad/impact/issues) | Scope, acceptance, delivery intent |
...
**Archive:** personal [Project #2](https://github.com/users/moldovancsaba/projects/2) — do not change Status there.

**Reapply board columns:** `bash scripts/gh-issue-bodies/apply-status.sh` (maintainers).
